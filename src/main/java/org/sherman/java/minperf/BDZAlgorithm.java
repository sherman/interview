...
public class BDZAlgorithm<T> {
    ...
    private BDZAlgorithm(UniversalHash<T> hash, BitBuffer data) {
        this.hash = hash;
        this.data = data;
    ...
    public static <T> BDZAlgorithm<T> load(UniversalHash<T> hash, BitBuffer data) {
        return new BDZAlgorithm<T>(hash, data);
    }
